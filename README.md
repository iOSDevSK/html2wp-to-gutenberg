...
GPL-2.0-or-later. WordPress is licensed under the GPL, version 2 or later, and
the PHP this skill carries — the importer's shape, the cleanup, the form blocks
— lands inside the themes it generates; a GPL-compatible licence is what keeps
those themes distributable, on WordPress.org or anywhere else. The full text is
in [LICENSE](LICENSE).
